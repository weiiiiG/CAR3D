...
const CO:Record<string,any>={front:{radar:{center:['50%','52%'],radius:'65%',indicator:[{name:'马力',max:1500},{name:'扭矩',max:1200},{name:'极速',max:350},{name:'零百',max:3.5},{name:'下压力',max:500}],axisName:{color:'#92949E',fontSize:11},splitArea:{areaStyle:{color:['rgba(255,188,10,0.04)','rgba(255,188,10,0.10)']}},splitLine:{lineStyle:{color:'rgba(228,229,235,0.12)'}},axisLine:{lineStyle:{color:'rgba(228,229,235,0.12)'}}},series:[{type:'radar',data:[{value:[1244,1155,301,2.7,450]}],areaStyle:{color:'rgba(255,188,10,0.28)'},lineStyle:{color:'#FFBC0A',width:2},itemStyle:{color:'#FFBC0A'}}]},side:{tooltip:{trigger:'axis'},grid:{left:46,right:12,top:12,bottom:28},xAxis:{type:'category',data:['车长','车宽','车高','轴距'],axisLabel:{color:'#92949E',fontSize:11,interval:0},axisLine:{lineStyle:{color:'rgba(228,229,235,0.18)'}}},yAxis:{type:'value',axisLabel:{color:'#6B7280',fontSize:10,formatter:'{value}mm'},splitLine:{lineStyle:{color:'rgba(228,229,235,0.08)'}}},series:[{type:'bar',data:[4650,1960,1130,2800],itemStyle:{color:'#FFBC0A'},barMaxWidth:40,label:{show:true,position:'top',color:'#FFBC0A',fontSize:10,formatter:'{c}mm'}}]},'45':{tooltip:{trigger:'item',formatter:'{b}: {c}%'},series:[{type:'pie',radius:['35%','55%'],center:['50%','52%'],avoidLabelOverlap:true,label:{color:'#92949E',fontSize:11,formatter:'{b}\n{d}%'},labelLine:{length:10,length2:8},data:[{value:45,name:'碳纤维',itemStyle:{color:'#2D3040'}},{value:30,name:'Alcantara',itemStyle:{color:'#6B7280'}},{value:15,name:'真皮',itemStyle:{color:'#FFBC0A'}},{value:10,name:'铝合金',itemStyle:{color:'#D99A00'}}]}]},interior:{tooltip:{trigger:'axis'},grid:{left:44,right:12,top:12,bottom:26},xAxis:{type:'category',data:['1k','2k','3k','4k','5k','6k','7k'],axisLabel:{color:'#92949E',fontSize:11,interval:0},axisLine:{lineStyle:{color:'rgba(228,229,235,0.18)'}}},yAxis:{type:'value',name:'转速rpm',nameTextStyle:{color:'#6B7280',fontSize:10},axisLabel:{color:'#6B7280',fontSize:10},splitLine:{lineStyle:{color:'rgba(228,229,235,0.08)'}}},series:[{type:'line',data:[15,40,80,140,200,270,301],smooth:true,areaStyle:{color:'rgba(255,188,10,0.18)'},lineStyle:{color:'#FFBC0A',width:2},itemStyle:{color:'#FFBC0A'},label:{show:true,color:'#FFBC0A',fontSize:9,formatter:'{c}mph'}}]},doors:{tooltip:{trigger:'axis'},grid:{left:40,right:12,top:12,bottom:26},xAxis:{type:'category',data:['碳纤维','钢材','铝合金'],axisLabel:{color:'#92949E',fontSize:11,interval:0},axisLine:{lineStyle:{color:'rgba(228,229,235,0.18)'}}},yAxis:{type:'value',name:'kg',nameTextStyle:{color:'#6B7280',fontSize:10},axisLabel:{color:'#6B7280',fontSize:10},splitLine:{lineStyle:{color:'rgba(228,229,235,0.08)'}}},series:[{type:'bar',barMaxWidth:40,data:[{value:2.7,itemStyle:{color:'#FFBC0A'}},{value:8.5,itemStyle:{color:'#6B7280'}},{value:5.1,itemStyle:{color:'#8B8FA0'}}],label:{show:true,position:'top',color:'#FFBC0A',fontSize:10,formatter:'{c}kg'}}]},wheels:{series:[{type:'gauge',startAngle:200,endAngle:-20,min:0,max:320,center:['50%','55%'],radius:'80%',axisLine:{lineStyle:{width:10,color:[[0.3,'#6B7280'],[0.7,'#FFBC0A'],[1,'#D99A00']]}},axisLabel:{color:'#6B7280',fontSize:10,distance:6},splitLine:{length:8},detail:{formatter:'{value} km/h',color:'#E4E5EB',fontSize:13,offsetCenter:[0,'55%']},title:{color:'#92949E',fontSize:11,offsetCenter:[0,'35%']},data:[{value:196,name:'极速锁定'}]}]}}
